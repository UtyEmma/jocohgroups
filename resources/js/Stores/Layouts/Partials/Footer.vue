        ...
        <div class="md:max-w-6xl mx-auto space-y-10">
            <div class="md:flex px-4 md:divide-x space-y-10 md:space-y-0 py-10 md:py-0 border-y text-white border-[#ffffff30] divide-[#ffffff30]">
                ...
                <div class="md:py-10 md:pl-10 space-y-5" >
                    <ul class="md:space-y-5 flex md:space-x-0 space-x-4 md:block items-center" >
            ...
            <div class="text-center md:pt-10 text-sm md:text-base text-[#C9D7D2]">
                <p>© Copyright - <a :href="route('stores.home')" class="text-[#F2C200]" >{{settings.company_name}}</a> | {{date.getFullYear()}}</p>
            </div>
        </div>
    </section>
</template>