<script setup >
import CallIcon from '@/Group/Icons/CallIcon.vue';
import MailIcon from '@/Group/Icons/MailIcon.vue';
import LocationIcon from '@/Group/Icons/LocationIcon.vue';
