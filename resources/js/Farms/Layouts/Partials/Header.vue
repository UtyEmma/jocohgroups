...
<template>
    <header>
        ...
        <div class="md:flex mx-auto px-4 py-5 md:max-w-[80%] justify-between relative items-center">
            <div class="flex space-x-5 justify-between md:justify-normal items-center">
                <Link :href="route('farms.home')">
                    <img src="/assets/farms/images/logo.png" class="h-8 md:h-[40px]" alt="">
                </Link>
                ...
                <div class="block md:hidden">
                    ...
                    <ul v-if="show" ref="el" class="absolute z-50 border-y px-4 py-3 shadow-sm divide-y-[1px] top-[100%] left-0 right-0 bg-white">
                        <li>
                            <Link class="py-4 block" :href="route('farms.home')">Home</Link>
                        </li>
                        <li >
